...
#ifndef API_MSGS__SRV__DETAIL__FILE_RENAME__FUNCTIONS_H_
#define API_MSGS__SRV__DETAIL__FILE_RENAME__FUNCTIONS_H_
...
/// Initialize srv/FileRename message.
/**
...
/// Finalize srv/FileRename message.
/**
...
/// Create srv/FileRename message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * api_msgs__srv__FileRename_Request__init().
...
/// Destroy srv/FileRename message.
/**
 * It calls
 * api_msgs__srv__FileRename_Request__fini()
...
/// Check for srv/FileRename message equality.
/**
...
/// Initialize array of srv/FileRename messages.
/**
...
/// Finalize array of srv/FileRename messages.
/**
 * It calls
 * api_msgs__srv__FileRename_Request__fini()
...
/// Create array of srv/FileRename messages.
/**
 * It allocates the memory for the array and calls
 * api_msgs__srv__FileRename_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FileRename messages.
/**
 * It calls
 * api_msgs__srv__FileRename_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FileRename message array equality.
/**
...
/// Copy an array of srv/FileRename messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * api_msgs__srv__FileRename_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It calls
 * api_msgs__srv__FileRename_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It allocates the memory for the array and calls
 * api_msgs__srv__FileRename_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It calls
 * api_msgs__srv__FileRename_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // API_MSGS__SRV__DETAIL__FILE_RENAME__FUNCTIONS_H_
