...
#ifndef API_MSGS__SRV__DETAIL__IO_REQUEST__FUNCTIONS_H_
#define API_MSGS__SRV__DETAIL__IO_REQUEST__FUNCTIONS_H_
...
/// Initialize srv/IoRequest message.
/**
...
/// Finalize srv/IoRequest message.
/**
...
/// Create srv/IoRequest message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * api_msgs__srv__IoRequest_Request__init().
...
/// Destroy srv/IoRequest message.
/**
 * It calls
 * api_msgs__srv__IoRequest_Request__fini()
...
/// Check for srv/IoRequest message equality.
/**
...
/// Initialize array of srv/IoRequest messages.
/**
...
/// Finalize array of srv/IoRequest messages.
/**
 * It calls
 * api_msgs__srv__IoRequest_Request__fini()
...
/// Create array of srv/IoRequest messages.
/**
 * It allocates the memory for the array and calls
 * api_msgs__srv__IoRequest_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/IoRequest messages.
/**
 * It calls
 * api_msgs__srv__IoRequest_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/IoRequest message array equality.
/**
...
/// Copy an array of srv/IoRequest messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * api_msgs__srv__IoRequest_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It calls
 * api_msgs__srv__IoRequest_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It allocates the memory for the array and calls
 * api_msgs__srv__IoRequest_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It calls
 * api_msgs__srv__IoRequest_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // API_MSGS__SRV__DETAIL__IO_REQUEST__FUNCTIONS_H_
