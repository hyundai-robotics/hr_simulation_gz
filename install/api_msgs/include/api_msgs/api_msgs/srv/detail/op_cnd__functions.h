...
#ifndef API_MSGS__SRV__DETAIL__OP_CND__FUNCTIONS_H_
#define API_MSGS__SRV__DETAIL__OP_CND__FUNCTIONS_H_
...
/// Create srv/OpCnd message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * api_msgs__srv__OpCnd_Request__init().
...
/// Destroy srv/OpCnd message.
/**
 * It calls
 * api_msgs__srv__OpCnd_Request__fini()
...
/// Check for srv/OpCnd message equality.
/**
...
/// Initialize array of srv/OpCnd messages.
/**
...
/// Finalize array of srv/OpCnd messages.
/**
 * It calls
 * api_msgs__srv__OpCnd_Request__fini()
...
/// Create array of srv/OpCnd messages.
/**
 * It allocates the memory for the array and calls
 * api_msgs__srv__OpCnd_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OpCnd messages.
/**
 * It calls
 * api_msgs__srv__OpCnd_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/OpCnd message array equality.
/**
...
/// Copy an array of srv/OpCnd messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * api_msgs__srv__OpCnd_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It calls
 * api_msgs__srv__OpCnd_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It allocates the memory for the array and calls
 * api_msgs__srv__OpCnd_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_api_msgs
...
/**
 * It calls
 * api_msgs__srv__OpCnd_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // API_MSGS__SRV__DETAIL__OP_CND__FUNCTIONS_H_
