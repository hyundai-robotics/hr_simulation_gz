...
class Metaclass_Number(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from api_msgs.srv import _number
...
class Number(metaclass=Metaclass_Number):
    from api_msgs.srv._number import Number_Request as Request
    from api_msgs.srv._number import Number_Response as Response
